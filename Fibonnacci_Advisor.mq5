...
// Update the EA at every period below:
   ...
   if(CheckNewBar(PERIOD_M5) != 1)
   ...
   else
     {
      ...
      //Comment("Fibs: "+Fibs
      //        +"\nJust created SP bullet: "+SP_Bullets_AreaCheck(PERIOD_H1, Supp_Zone_H1,Resi_Zone_H1));
      //
      //   int strategyNum0 = SP_Bullets_AreaCheck(PERIOD_H1, Supp_Zone_H1,Resi_Zone_H1);
      //
      int randNumber = 3 + 3*MathRand()/32768; // 3-5
      //
      //   if(strategyNum0 == 1 && getCandleTheSizeOf(rates,16) == 1)
      //     {
      ...
      //     }
      //   else
      //      if(strategyNum0 == 0 && getCandleTheSizeOf(rates,16) == 1)
      //        {
      ...
      //Comment("Market_Dir: "+MarketDir
      //        +"\n\nADX: "+ADX_status_H1
      //        +"\nDI_STAT: "+DI_status_H1
      //        +"\nMA_PRICE: "+MA_PriceAction_Status_H1
      //        +"\nTrendLine: "+trendline_status_H1);
      ...
      //Comment("BuyVol: "+Buying_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE), // Volume
      //                                 Supp_Zone_M5
      //                                 ,Ask)
      //        +"\nSellVol: "+Selling_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE),(Resi_Zone_M5), // Volume to trade with
      //                                      Bid));
      ...
      //      //   if(strategyNum_1 == 1)
      //     }
      //trade.BuyLimit(0.01,Support_and_Resistance_Prices(indicator_handleSupRes_M5,1,1),
      //               Symbol(),0,Support_and_Resistance_Prices(indicator_handleSupRes_M5,1,1) + 10*_Point,0,0,"StraT_0000");
      //trade.SellLimit(0.1,Support_and_Resistance_Prices(indicator_handleSupRes_M5,1,0),
      //                Symbol(),0,Support_and_Resistance_Prices(indicator_handleSupRes_M5,1,0) - 10*_Point,0,0,"StraT_0000");

      //placeOrders_Pivot_SupportResistance(indicator_handlePivot_H4_vis_to_M5,PERIOD_M5);
      ...
      //         trade.Buy(Buying_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE), // Volume
      //                                 Supp_Zone_M5
      //                                 ,Ask),Symbol(),Ask,Supp_Zone_M5,(Ask + randNumber*MathAbs(Ask - Supp_Zone_M5)),"StraT_1");
      //
      //        }
      //     }
      //   else
      ...
      //            trade.Sell(Selling_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE),(Resi_Zone_M5), // Volume to trade with
      //                                      Bid)
      //                       ,Symbol(),Bid,Resi_Zone_M5,(Bid - randNumber*MathAbs(Bid - Resi_Zone_M5)),"StraT_1");
      //           }
      //        }
         ...
         if(Symbol()==PositionGetSymbol(i))
           {
            ...
            //              {
            //               if(changeSLSelling(PositionGetDouble(POSITION_SL),Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,0),PositionGetDouble(POSITION_PRICE_OPEN)
            //                                  ,PositionGetString(POSITION_COMMENT)) == 0
            //                 )
            //                 {
            //
            //                  // Revive the trade: Sell
            //                  Revive_Trailling_Stopped_Trades(0,Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates) + 100*_Point,
            //                                                  (Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,0) -
            //                                                   randNumber*MathAbs(
            //                                                      Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,0) -
            //                                                      (Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates) + 100*_Point))),
            //                                                  Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,0)
            //                                                 );
            //                 }
            //
            //               //trade.SellStop(Selling_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE), // Volume
            //               //                              Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates) + 50*_Point
            //               //                              ,Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,0)),
            //               //               Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,0),
            //               //               Symbol(),Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates) + 50*_Point // SL
            //               //               ,(Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,0) -
            //               //                 randNumber*MathAbs(
            //               //                    Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,0) - (Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates) + 50*_Point)))// TP
            //               //               ,0,0,
            ...
            //              {
            //               if(changeSLBuying(PositionGetDouble(POSITION_SL), Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1),PositionGetDouble(POSITION_PRICE_OPEN)
            //                                 ,PositionGetString(POSITION_COMMENT)) == 1
            //                 )
            //                 {
            //                  Revive_Trailling_Stopped_Trades(1,Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 100*_Point,
            //                                                  (Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1) +
            //                                                   randNumber*MathAbs(
            //                                                      Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1) -
            //                                                      (Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 100*_Point))),
            //                                                  Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1)
            //                                                 );
            //
            //                 }
            ...
            //trade.BuyStop(Buying_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE), // Volume
            //                            Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 50*_Point
            //                            ,Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1)), // Volume
            //              Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1),
            //              Symbol(),Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 50*_Point // SL
            //              ,(Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1) +
            //                randNumber*MathAbs(
            //                   Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1) - (Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 50*_Point)))// TP
            //              ,0,0,
      ...
      //        {
      //         Revive_Trailling_Stopped_Trades(1,Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 50*_Point,
      //                                         (Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1) +
      //                                          randNumber*MathAbs(
      //                                             Support_and_Resistance_Prices(indicator_handleSupRes_H1,1,1) -
      //                                             (Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 50*_Point))),
      ...
      //Comment("BreakStructure TrendLine: "+BreakStructureTrendline(indicator_Trending_Angle_H1_1,PERIOD_H1)
      //        +"\nBreakSTructure ADX STYLE: "+BreakStructurePriceAction_ADX(adx_indicator_handle_H1,PERIOD_H1));

      //ChangeOrderDirection(MarketDir_M5, MarketDir_H1, MarketDir_H4,BreakStruc_TrendLine_H1);

      //for(int i=0; i<7; i++)
      //  {
      //   Print("Pivot Prices["+i+"]: "+PivotBufferPrices(indicator_handlePivot_H4_vis_to_M5,PERIOD_M5,i));
      //  }
      //Comment("Detect: "+Detect_Pivot_Prices_Zone(PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,4),
      //        PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,3),PERIOD_D1,rates));

      // MN1 Support_resistance LEVELS
      //Fill_Spaces_With_BuySell_Stops(Detect_Pivot_Prices_Zone(PivotBufferPrices(indicator_handlePivot_MN1_vis_to_M5,PERIOD_M5,4),
      //                               PivotBufferPrices(indicator_handlePivot_MN1_vis_to_M5,PERIOD_M5,3),PERIOD_MN1,rates),
      //                               PivotBufferPrices(indicator_handlePivot_MN1_vis_to_M5,PERIOD_M5,4),
      //                               PivotBufferPrices(indicator_handlePivot_MN1_vis_to_M5,PERIOD_M5,3),PERIOD_MN1
      //                              );
      // D1 Support_resistance LEVELS
      //Fill_Spaces_With_BuySell_Stops(Detect_Pivot_Prices_Zone(PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,4),
      //                               PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,3),PERIOD_D1,rates),
      //                               PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,4),
      //                               PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,3),PERIOD_D1
      //                              );
      // H4 Support_resistance LEVELS
      //Fill_Spaces_With_BuySell_Stops(Detect_Pivot_Prices_Zone(PivotBufferPrices(indicator_handlePivot_H4_vis_to_M5,PERIOD_M5,4),
      //                               PivotBufferPrices(indicator_handlePivot_H4_vis_to_M5,PERIOD_M5,3),PERIOD_H4,rates),
      //                               PivotBufferPrices(indicator_handlePivot_H4_vis_to_M5,PERIOD_M5,4),
      //                               PivotBufferPrices(indicator_handlePivot_H4_vis_to_M5,PERIOD_M5,3),PERIOD_H4
      //                              );


      // Insured trades tests:
      //Insured_Filled_Spaces_With_BuySell_Stops(Detect_Pivot_Prices_Zone(PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,4),
      //      PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,3),PERIOD_D1,rates),
      //      PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,4),
      //      PivotBufferPrices(indicator_handlePivot_D1_vis_to_M5,PERIOD_M5,3),PERIOD_D1
      //                                        );

      //Fill_Spaces_With_BuySell_Stops_VERSION_2(MA_Prices_Return(indicator_customMA_H1_1,indicator_customMA_H1_2,PERIOD_H1,1),PERIOD_H1);


      //Fill_Spaces_With_BuySell_Stops_VERSION_3(MA_Prices_Return(indicator_customMA_H1_1,indicator_customMA_H1_2,PERIOD_H1,1)
      //      ,MA_Cross(indicator_customMA_H1_1,indicator_customMA_H1_2),
      //      MA_PriceAction(indicator_customMA_H1_1,indicator_customMA_H1_2,PERIOD_H1),PERIOD_H1);

      //Print("MA CROSS: "+MA_Cross(indicator_customMA_H1_1,indicator_customMA_H1_2));

      //Hanging_Trades_Prevention_Sys(PivotBufferPrices_D1,50);
      //Hanging_Trades_Prevention_Sys(PivotBufferPrices_D1,50);
      //Hanging_Trades_Prevention_Sys(PivotBufferPrices_MN1,100);
      //for(int i=0; i<7; i++)
      //  {
      //   Print("pricccce "+PivotBufferPrices_D1[i]);
      //  }
      //Comment("Higher vs Lower : "+Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates)
      //        +"\n "+Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates)
      //        +"\n "+MA_PriceAction(indicator_customMA_H1_1,indicator_customMA_H1_2,PERIOD_H1));
      //Comment("  triggered SL "+triggeredSLEarly);
      ...
      //int strategyNum_2 = strategyNum2(MA_Prices_Return(indicator_customMA_H1_1,indicator_customMA_H1_2,PERIOD_H1,1)
      //                                 ,MA_Cross(indicator_customMA_H1_1,indicator_customMA_H1_2),
      //                                 MA_PriceAction(indicator_customMA_H1_1,indicator_customMA_H1_2,PERIOD_H1),PERIOD_H1);
      ...
      //         if(PositionSelect(Symbol())==false)
      //           {
      //            //if((PositionGetInteger(POSITION_TYPE) != 0) || PositionSelect(Symbol())==false)
      //            //  {
      //            trade.Buy(Buying_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE), // Volume
      //                                    Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 100*_Point
      //                                    ,Ask),Symbol(),Ask,Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 100*_Point,
      //                      (Ask + randNumber*MathAbs(Ask - (Lower_Higher_Support_Resistance(PivotBufferPrices_D1,0,rates) - 100*_Point))),"Buy StraT_2 WOW");
      //            //}
      //
      //
      //           }
      ...
      //               //if(PositionGetInteger(POSITION_TYPE) == 0 || PositionSelect(Symbol())==false)
      //               //  {
      //               trade.Sell(Selling_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE),
      //                                         (Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates) + 100*_Point), // Volume to trade with
      //                                         Bid)
      //                          ,Symbol(),Bid,Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates) + 100*_Point,
      //                          (Bid - randNumber*MathAbs(Bid - (Lower_Higher_Support_Resistance(PivotBufferPrices_D1,1,rates) + 100*_Point))),"Sell StraT_2 WOW");
      //               //}
      //
      //              }
      //           }
      ...
      // Strategy Number 4:
      //int strategyNum_4 = strategyNum3(MA_Cross_Continuous(indicator_customMA_H4_1,indicator_customMA_H4_2)
      //                                 ,MA_Cross(indicator_customMA_M15_1,indicator_customMA_M15_2));
      //// Strategy Number 3:
      //int strategyNum_5 = strategyNum3(MA_Cross_Continuous(indicator_customMA_H4_1,indicator_customMA_H4_2)
      //                                 ,MA_Cross(indicator_customMA_H1_1,indicator_customMA_H1_2));
      //// Strategy Number 3:
      //int strategyNum_6 = strategyNum3(MA_Cross_Continuous(indicator_customMA_H4_1,indicator_customMA_H4_2)
      //                                 ,MA_Cross(indicator_customMA_M30_1,indicator_customMA_M30_2));
      //// Strategy Number 3:
      //int strategyNum_7 = strategyNum3(MA_Cross_Continuous(indicator_customMA_MN1_1,indicator_customMA_MN1_2)
      //                                 ,MA_Cross(indicator_customMA_D1_1,indicator_customMA_D1_2));
      //// Strategy Number 3:
      //int strategyNum_8 = strategyNum3(MA_Cross_Continuous(indicator_customMA_D1_1,indicator_customMA_D1_2)
      //                                 ,MA_Cross(indicator_customMA_H4_1,indicator_customMA_H4_2));

      //                                       MA_Cross(indicator_customMA_H4_1,indicator_customMA_H4_2)

      Comment("Strat#10101: "+strategyNum_10101);
      ...
      if(strategyNum_3 == 1)
        {
         ...
         //DCA_RiskTrade_Breakdown(1.25,(Ask - 800*_Point),Ask + 10*_Point,Ask,1,"strat_0 Buy");

         //trade.Buy(Buying_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE), // Volume
         //                        Supp_Zone_M5
         //                        ,Ask),Symbol(),Ask,Supp_Zone_M5,(Ask + randNumber*MathAbs(Ask - Supp_Zone_M5)),"StraT_1");
         //Delete_All_Orders("ff");
         //Crypto_DCA_Strat(Ask,1,"Crypto Power Buy");
         ...
         if(strategyNum_3 == 0)
           {
            ...
            //triggeredTP = -1;
            // Test DCA Risk management
            //DCA_RiskTrade_Breakdown(1.25,(Ask - 800*_Point),Ask + 10*_Point,Ask,0,"strat_0 Sell");

            //trade.Sell(Selling_Volume(0.01*AccountInfoDouble(ACCOUNT_BALANCE),(Resi_Zone_M5), // Volume to trade with
            //                          Bid)
            //           ,Symbol(),Bid,Resi_Zone_M5,(Bid - randNumber*MathAbs(Bid - Resi_Zone_M5)),"StraT_1 Sell");
            //trade.Sell(0.56
            //           ,Symbol(),Bid,0,Bid-2000*_Point,"StraT_1");
            //Delete_All_Orders("ff");
            //Crypto_DCA_Strat(Bid,0,"Crypto Power Sell");
            ...
            if(PositionSelect(Symbol()) == false)
              {
               ...
               DCA_RiskTrade_Breakdown(1.25,(Ask - 800*_Point),Ask + 10*_Point,Ask,0,"strat_0 Buy");
              }
      ...
      //Print("#Positions: "+PositionsTotal()+"  #Orders: "+OrdersTotal());


      // Un = Sum (pd*ss^n)
      //for(int i=0; i<200; i++)
      //  {
      //   testingSum += (0.023564/100)*MathPow((1.19),i);
      //   //Print("Testing Sum: ["+i+"]:  "+testingSum);
      //  }
      //Print(" profit: "+(2.8*Profits_Summation_Positions()));
      Print("Minute Counter: "+minute_Counter_3);

      //Print(" "+);


      //DCA_Grid_Bots(Ask,-1,"newGrid strat00");
...
//DCA_Crypto_Fulfilled(Crypto_Interval_Web_Zone);
   ...
   for(int i=0; i<PositionsTotal(); i++)
     {
      ...
      //
      //      if(average_new_TP > PositionGetDouble(POSITION_PRICE_OPEN) && Buy_Or_Sell == 1)
      //        {
      //         // get ticket number
      //         ulong PositionTicket = PositionGetTicket(i);
      //
...
void Right_Placing_Inputs()
  {
   if(Symbol() == "AUDUSD")
     {
      TP_AdditionalPoints = 52; // From AUDUSD standPoint;
      Trades_Increment_Step = 200; // From AUDUSD standPoint;
   ...
   if(Symbol() == "EURUSD")
     {
      TP_AdditionalPoints = 52;
      Trades_Increment_Step = 200;
      Volume_Chosen = 0.03;
     }
   if(Symbol() == "GBPUSD")
     {
...
//+------------------------------------------------------------------+
int DCA_RiskTrade_Breakdown(double volume_PreviouslyRequired, double Stop_Loss, double Take_Profit, double Ask_Price, int Buy_Or_Sell, string comment_strat)
  {
      ...
      for(int i=0; i<=number_Of_Trades; i++)
        {
         ...
         if(i>=4)
           {
            sum_lots_bUY += NormalizeDouble(sum_lots_bUY*MathPow(1.80,1),decimal_places);
           }
         else
            if(i == 8)
              {
               sum_lots_bUY += NormalizeDouble(sum_lots_bUY*MathPow(1.07,i),decimal_places);
              }
            else
              {
               sum_lots_bUY += NormalizeDouble(sum_lots_bUY*MathPow(1.19,i),decimal_places);
              }
         //// Prevents any order of the same volume to be cast in the web.
         //if(volume_Already_Exists(sum_lots_bUY) == false)
         //  {
         //trade.BuyLimit(sum_lots_bUY,Trade_Price(Ask_Price,i,1),Symbol(),
         //               0,Trade_Price(Ask_Price,i,1) + TP_AdditionalPoints*_Point*MathPow(1.12,i),0,0,comment_strat);
         //}

         //trade.BuyLimit(sum_lots_bUY,Ask_Price - i*10*_Point,Symbol(),
         //               0,Ask_Price - i*10*_Point + Points_Converter(12)*_Point*MathPow(1.12,i),0,0,comment_strat);
         //trade.BuyLimit(0.01,Ask_Price - i*Trades_Increment_Step*_Point,Symbol(),
         //               0,Ask_Price - i*Trades_Increment_Step*_Point + TP_AdditionalPoints*_Point*MathPow(1.12,i),0,0,comment_strat);
         ...
         // This part will play on the trading price getting bigger:
         //trade.BuyLimit(Volume_Chosen,Ask_Price - i*Trades_Increment_Step*_Point,Symbol(),
         //               0,Ask_Price - i*Trades_Increment_Step*_Point + TP_AdditionalPoints*_Point*MathPow(1.0001,i),0,0,comment_strat);


        }
      //if(PositionsTotal() >= 198 && OrdersTotal() < 3)
      //  {
      //   Trading_Patches_Prices[patches_counter] = Ask_Price - 199*Trades_Increment_Step*_Point;
      //   allow_Patch = true;
      //  }
   ...
   if(Buy_Or_Sell == 0 && OrdersTotal() < number_Of_Trades - 2)
     {
      for(int i=0; i<=number_Of_Trades; i++)
        {
         if(i>=4)
         ...
         //trade.BuyLimit(sum_lots_bUY + NormalizeDouble(Volume_Scale*MathPow(Safety_order_volume_scale,i-1),decimal_places),Trade_Price(Ask_Price,i),Symbol(),
         //               Trade_Price(Ask_Price,Max_safety_trades_count)-Points_Converter(600)*_Point,Trade_Price(Ask_Price,i) + Points_Converter(100)*_Point*MathPow(1.12,i));
         //Print("i : "+i);
         //trade.BuyLimit(Safety_order_size*MathPow(Safety_order_volume_scale,i-1),Trade_Price(Ask,i),Symbol(),
         //               Trade_Price(Ask,Max_safety_trades_count)*(1-Stop_Loss),Trade_Price(Ask,i)*(1+Target_profit));

         //trade.BuyLimit(NormalizeDouble(Volume_Scale*MathPow(Safety_order_volume_scale,i-1),decimal_places),Trade_Price(Ask_Price,i),Symbol(),
         //                Trade_Price(Ask_Price,Max_safety_trades_count)-Points_Converter(1000)*_Point,Trade_Price(Ask_Price,i) + Points_Converter(10)*_Point*MathPow(1.12,i));
   ...
   if(triggeredTP == 1)
     {
      ...
      //DCA_RiskTrade_Breakdown(1.25,(Ask - 800*_Point),Ask + 10*_Point,Ask,1,"strat_0");
     }
